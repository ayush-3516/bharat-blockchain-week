...
const Header = () => {
    return (
        <header className="text-gray-600 body-font">
            ...
            <div className="container mx-auto flex flex-wrap px-5 py-4 bg-gradient-to-r from-purple-50 to-purple-100 shadow flex-col md:flex-row items-center">
                ...
                <button className="inline-flex items-center bg-gray-100 border-2 border-black py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Button
