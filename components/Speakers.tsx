...
const TeamMember: React.FC<TeamMemberProps> = ({ name, role, imageSrc }) => (
    <div className="p-5 lg:w-1/5 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
            <Image alt="team" width="100%" height="100%" className="flex-shrink-0 rounded-3xl w-60 h-52 object-cover border-4 border-[#a855f7] shadow-md shadow-purple-200 object-center mb-4" src={imageSrc} />
